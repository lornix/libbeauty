...
struct test_data_s test_data[] = {
	...
	},
	{
		...
		.bytes_size = 8,
		.inst[0] = "// 0x0000:IMUL  r0x8/64, i0x8/64, r0x90/64",
	...
	},
	{
		...
		.inst[0] = "// 0x0000:SUB  r0x30/64, i0x4/64, r0x90/64",
		.inst[1] = "// 0x0001:LOAD  s[r0x90]/32, r0x98/32",
		.inst[2] = "// 0x0002:ADDf r0x98/32, r0x8/32, r0x98/32",
		.inst[3] = "// 0x0003:STORE  r0x98/32, r0x90/64, s[r0x90]/32",
		.inst_size = 4,
	},
	{
	...
	},
	{
		...
		.inst[3] = "// 0x0003:LOAD  m[r0x38]/64, r0x98/64",
		.inst[4] = "// 0x0004:STORE  r0x98/64, r0x40/64, m[r0x40]/64",
