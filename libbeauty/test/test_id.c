...
struct test_data_s test_data[] = {
	...
	},
	{
		...
		.inst[1] = "// 0x0001:LOAD  s[r0x160]/8, r0x180/8",
	...
	},
	{
		...
		.inst[1] = "// 0x0001:LOAD  m[r0x160]/8, r0x180/8",
	...
	},
	{
		...
		.inst[1] = "// 0x0001:LOAD  m[r0x160]/64, r0x180/64",
	...
	},
	{
		...
		.inst[1] = "// 0x0001:LOAD  m[r0x160]/32, r0x180/32",
	...
	},
	{
		...
		.bytes = {0xc3},
		.bytes_size = 1,
		.inst[0] = "// 0x0000:LOAD  s[r0x28]/64, r0x160/64",
	...
	},
	{
		...
		.inst[1] = "// 0x0001:LOAD  s[r0x160]/32, r0x180/32",
	...
	},
	{
		...
		.inst[2] = "// 0x0002:LOAD  m[r0x160]/64, r0x180/64",
	...
	},
	{
		...
		.inst[1] = "// 0x0001:LOAD  s[r0x160]/64, r0x180/64",
	...
	},
	{
		...
		.inst[3] = "// 0x0003:LOAD  m[r0x38]/64, r0x180/64",
